...
| Item | Evidence |
| --- | --- |
| Guild v2 — Supervisor complete (2.0.0) | [design / roadmap](plans/2026-08-20-guild-v2-design.md); [run 12](evals/2026-08-20-run-12.md) 10/12; [run 13](evals/2026-08-20-run-13.md) 11/12 FAIL — `-fixes` gone, `close.md` still `VERIFIED (`. Follow-up: [close-file stickiness](plans/2026-08-20-guild-v2-close-stick-design.md). Do not bump `VERSION`. 2.1 Adaptive and 2.2 graph wait. |
