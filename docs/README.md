...
| Item | Evidence |
| --- | --- |
| Guild v2 — Supervisor complete (2.0.0) | [design / roadmap](plans/2026-08-20-guild-v2-design.md); [run 13](evals/2026-08-20-run-13.md) 11/12 FAIL. Follow-up: [close.md procedure design](plans/2026-08-20-guild-v2-close-procedure-design.md); [plan](plans/2026-08-20-guild-v2-close-procedure.md). Do not bump `VERSION`. 2.1 Adaptive and 2.2 graph wait. |
