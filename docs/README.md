...
| Item | Evidence |
| --- | --- |
| Guild v2 — 2.1 Adaptive | [design](plans/2026-08-23-guild-v2-adaptive-design.md); [plan](plans/2026-08-23-guild-v2-adaptive.md); [run 18](evals/2026-08-23-run-18.md) — billed Adaptive packet, peer-router.md, and handoff FAIL; close file PASS. VERSION stays 2.0.0. |
